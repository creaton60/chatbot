...
public enum ApiMessageType {
    ...
    MESSAGE_EVENT_INFO(ApiValues.VALUE_EVENT_INFO),
    ...
    MESSAGE_CHAT_INFO(ApiValues.VALUE_CHAT_INFO),
    MESSAGE_MENU_CREATE(ApiValues.VALUE_MENU_CREATE),
    MESSAGE_MENU_MODIFY(ApiValues.VALUE_MENU_MODIFY),
    MESSAGE_MENU_LIST(ApiValues.VALUE_MENU_LIST),
    MESSAGE_MENU_INFO(ApiValues.VALUE_MENU_INFO),
    ...
    public static class ApiValues{
        ...
        public static final String VALUE_EVENT_INFO="eventInfo";
        ...
        public static final String VALUE_CHAT_INFO="chatInfo";
        public static final String VALUE_MENU_CREATE="createMenu";
        public static final String VALUE_MENU_MODIFY="modifyMenu";
        public static final String VALUE_MENU_INFO="menuInfo";
        public static final String VALUE_MENU_LIST="menuList";
